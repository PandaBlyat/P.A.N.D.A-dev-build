...
const NARRATOR_CHARACTER_DELAY_MS = 8;
const NARRATOR_CHARACTER_JITTER_MS = 8;
const NARRATOR_LINE_PAUSE_MS = 80;
const NARRATOR_PHASE_TRANSITION_MS = 220;
const NARRATOR_REVEAL_GROUP_DELAY_MS = 430;
