...
<p><code>spawn_custom_npc</code> always creates a roaming NPC near the player. Use <code>spawn_custom_npc_at</code> when a custom NPC needs to stay locked to a compatible stalker job on a smart terrain.</p>
